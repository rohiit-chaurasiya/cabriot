...
const MenuItemTabel = () => {
  ...
  useEffect(() => {
    const fetchKitchens = async () => {
      try {
        const response = await axios.get('https://admindashboard-fr4p.onrender.com/api/menuitem/');
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://admindashboard-fr4p.onrender.com/api/menuitem/${id}`);
      ...
      {!view && !selectedID && (
        <div className="flex flex-col">
          <div className="grid grid-cols-7 rounded-sm dark:bg-meta-4">
            <div className="p-1 text-center"><h5 className='font-semibold'>Dish Image</h5></div>
            <div className="p-1 text-center"><h5 className='font-semibold'>Dish Name</h5></div>
            <div className="p-1 text-center"><h5 className='font-semibold'>Base Price</h5></div>
            <div className="p-1 text-center"><h5 className='font-semibold'>Weight(gm)</h5></div>
