...
const MealPlanDishMultiSelect: React.FC<MultiSelectProps> = ({ id, options, selectedCities, onChange }) => {
...
//   console.log('options', options);
  ...
  useEffect(() => {
    const loadOptions = () => {
      ...
      // Set initially selected cities to the 'selected' state
...
export default MealPlanDishMultiSelect;
