...
const SignIn: React.FC = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(
        'https://cabriot-admin-auth.onrender.com/api/account/admin-login/',
        {
          email: email,
          password: password,
        },
      ...
      console.log(response.data); // Assuming successful response structure
      const { token, refresh_token } = response.data; // Assuming the response contains tokens
  ...
  // const forgotPasswordTesting = () => {
  //   window.open('https://cabriot-admin-auth.onrender.com/api/account/password-reset/', '_blank');
  // };
